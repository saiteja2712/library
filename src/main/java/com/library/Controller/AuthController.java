...
public class AuthController {
	...
	public AuthResponse signin(@RequestBody LoginRequest loginRequest )
	{
		...
		Power pow=powerRepo.findByEmail(loginRequest.getEmail());
		if(pow==null)
		{
	...
	public AuthResponse Createsuperuser(@RequestBody Super sup) throws Exception {
		...
		Endperson isExists=endrepo.findByEmail(sup.getEmail());
		if(isExists!=null)
		{
			throw new Exception("email already used with another account");
			
		}
		Power isExistPower = powerRepo.findByEmail(sup.getEmail());
	...
	public ResponseEntity<List<Endperson>>findallendusers(@RequestHeader("Authorization")String jwt,Power powers) throws Exception
	{
		Power pow=power.findUserByJwt(jwt);
	...
	@GetMapping("/super/getadmins")
	public ResponseEntity<List<Super>>findallsuperuseradmin(@RequestHeader("Authorization")String jwt,Power pow)
	{
		Power pows=power.findUserByJwt(jwt);
		List<Super>sup=superinter.getall();
		return new ResponseEntity<List<Super>>(sup,HttpStatus.OK);
